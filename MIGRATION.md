...
| editor-render | `src/core/{render_model,render_builder}.ixx` + `src/app-winui/{EditorContentPreparation,EditorTextLayoutEngine,EditorSvgPainter,EditorTableInteraction}.*` | ✅ 语义模型、平台内联内容准备、DirectWrite 布局、SVG 绘制与表格交互镀铬层分离 |
