...
namespace winrt::Folia
{
    ...
    void EditorSurfaceRenderer::DrawDocument(detail::EditorRenderFrame const& frame)
    {
        ...
        auto initializePreparedMetadata = [&](EditorPreparedDocument::Block& prepared, folia::RenderBlock const& block)
        {
        ...
        auto initializePreparedContentMetadata = [&](EditorPreparedDocument::Block& prepared, folia::RenderBlock const& block)
        {
        ...
        else
        {
            ...
            auto releaseImages = [&](EditorPreparedDocument::Block const& prepared)
            {
